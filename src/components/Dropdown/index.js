...
import "./style.scss";
import { ArrowBottom, Search } from "../../assets/icon/index.js";
import useInput from "../../utils/useInput";
import { DROPDOWN_ITEM } from "../../constants/DROPDOWN_ITEM.js";
...
const Dropdown = () => {
	...
	return (
		<div className={classnames("dropdown", { "--dark": theme })}>
			<div className="dropdown__main" onClick={onClickInput}>
			...
			{isModalOpen && (
				<div className="dropdown__modal">
					<div className="dropdown__modal__wrapper">
						...
						<img
							className="dropdown__modal__wrapper__search"
							src={Search}
							alt="search"
						/>
